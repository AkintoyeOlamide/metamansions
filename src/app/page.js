      ...
      <div className="relative z-10 flex flex-col md:flex-row items-center justify-center w-full max-w-5xl gap-8 px-4 py-12 mt-8">
        ...
        <section className="w-full max-w-xs bg-black/40 backdrop-blur-md border border-yellow-600/50 rounded-lg p-6 flex flex-col items-center shadow-lg hover:bg-black/50 transition-all">
          <div className="mb-4 flex items-center">
            ...
            <span className="ml-2 text-yellow-400 font-bold text-lg">Keys Metaverse</span>
          </div>
          <p className="text-gray-300 mb-4 text-sm text-center">Create an account to discover Meta Mansions and find ways to make money.</p>
          {error && (
          ...
          <form onSubmit={handleSignUp} className="w-full flex flex-col gap-3">
            <div className="w-full">
              <label htmlFor="email" className="text-gray-200 font-semibold mb-0 text-xs text-left">Email</label>
              <input
                type="email"
                id="email"
            ...
            <div className="flex justify-center gap-3 w-full mb-2">
              <button className="bg-white border border-gray-300 rounded-lg w-28 h-9 flex items-center justify-center hover:bg-gray-100 transition-colors" aria-label="Sign up with MetaMask">
                <Image src="/metmask.png" alt="MetaMask" width={20} height={20} />
              </button>
              <button className="bg-white border border-gray-300 rounded-lg w-28 h-9 flex items-center justify-center hover:bg-gray-100 transition-colors" aria-label="Sign up with Google">
              ...
              <button className="bg-white border border-gray-300 rounded-lg w-28 h-9 flex items-center justify-center hover:bg-gray-100 transition-colors" aria-label="Sign up with Telegram">
